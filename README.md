...
- When paired with a dependency updater such as [Renovate](https://docs.renovatebot.com/), the
  action can be updated automatically, and the builds become reproducible.
...
commit. [restore-nightly](restore-nightly/action.yml) restores the built Neovim nightly from cache
in a later job.
...
[busted](https://lunarmodules.github.io/busted/) tests with Neovim. It can be used to run tests for
Neovim plugins.
